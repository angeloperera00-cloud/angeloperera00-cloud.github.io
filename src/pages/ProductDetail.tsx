...
const ProductDetail = () => {
  ...
  const [selectedSize, setSelectedSize] = useState(1); // default Classic
        ...
        >
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              ...
              className="flex-1 py-4 bg-foreground text-primary-foreground font-body text-xs tracking-[0.25em] uppercase hover:opacity-90 transition-opacity"
            >
              Add to Cart
            </button>
          </div>
