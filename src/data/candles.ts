...
export const candles: CandleProduct[] = [
  {
    ...
    sizes: oneSize("One size", "3.3 x 4.5 cm", 2.5),
  },
  {
    slug: "peony-flower",
    name: "Peony Flower",
    ...
    sizes: [
      { label: "M", weight: "4.5 x 9.6 cm", price: 6.5 },
      { label: "L", weight: "5.5 x 11.5 cm", price: 10.0 },
    ],
...

  {
    ...
    sizes: oneSize("One size", "9.8 x 6.4 cm", 11.0),
  },
  {
    slug: "temple-flower",
    name: "Temple Flower",
    ...
    sizes: oneSize("One size", "7 x 2.2 cm", 2.5),
  },
  {
    slug: "daisy-flower",
    name: "Daisy Flower",
    ...
    sizes: oneSize("One size", "5.6 x 5.8 cm", 2.5),
  },
  {
    slug: "tulip",
    name: "Tulip",
    ...
    sizes: oneSize("One size", "4.3 x 1.69 cm", 3.0),
  },
  {
    slug: "rose",
    name: "Rose",
    ...
    sizes: oneSize("One size", "4.5 x 1.77 cm", 3.0),
  },
  {
    slug: "rose-bud",
    name: "Rose Bud",
    ...
    sizes: oneSize("One size", "4.7 x 1.85 cm", 3.5),
  },
  {
    slug: "yarn-ball",
    name: "Yarn Ball",
    ...
    sizes: oneSize("One size", "5.6 x 6.7 cm", 5.5),
  },
  {
    ...
    sizes: oneSize("One size", "5.7 x 6 cm", 6.5),
  },
  {
    ...
    sizes: oneSize("One size", "6.8 x 5.9 cm", 8.0),
  },
  {
    ...
    sizes: oneSize("One size", "6.5 x 10 cm", 12.0),
  },
  {
    ...
    sizes: oneSize("One size", "6.5 x 11 cm", 12.0),
  },
  {
    slug: "bless-angel",
    name: "Bless Angel",
    ...
    sizes: oneSize("One size", "6.1 x 10.5 cm", 9.0),
  },
  {
    ...
    sizes: oneSize("Small", "4 x 4 cm", 3.0),
  },
  {
    ...
    sizes: oneSize("Regular", "6 x 6 cm", 5.5),
  },
  {
    slug: "heart-shape",
    name: "Heart Shape",
    ...
    sizes: [
      { label: "Small", weight: "5 x 4.5 cm", price: 5.0 },
      { label: "Medium", weight: "7.7 x 6.9 cm", price: 8.0 },
      { label: "Large", weight: "10 x 9 cm", price: 11.0 },
    ],
  },
  {
    ...
    sizes: oneSize("Small", "5 x 8.7 cm", 6.0),
  },
  {
    ...
    sizes: oneSize("Large", "6.5 x 8.7 cm", 7.0),
  },
];
